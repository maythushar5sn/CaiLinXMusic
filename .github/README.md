...
- Get your [Necessary Variables](https://github.com/maythushar5sn/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/maythushar5sn/CaiLinXMusic && cd CaiLinXMusic
   ```
